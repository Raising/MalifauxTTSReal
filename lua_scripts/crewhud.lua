--ThatRobHuman MiniHUDController
...
config = {
    ACCESS = {const.HOST, const.ALL}, --list who can interact with this thing
...
function ui_follow_model(model)
    initiateLink({object=model})    
end
